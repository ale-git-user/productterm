 ...
 *
 */
public class NewEsTermsGenerator {
    ...
    public static void main(String[] args){
        ...
        NewEsTermsGenerator fg=new NewEsTermsGenerator(
     ...
     */
    public NewEsTermsGenerator(String fileBase, String descriptions, String language, String rels, String outDescFile, String outLangFile, String outTermsReview) {
